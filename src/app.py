...
<head>
  ...
  <base href="./">
  <title>Centrol Trader Bot - Centrol Signals</title>
  <meta property="og:title" content="Centrol Trader Bot - Centrol Signals" />
  <meta name="twitter:title" content="Centrol Trader Bot - Centrol Signals" />
  <meta name="og:image" content="assets/uploads/centrol-web-link-preview-image2.png?p=TWLCdXpM" />
  <meta name="twitter:image" content="assets/uploads/centrol-web-link-preview-image2.png?p=TWLCdXpM" />
  <link rel="preconnect" href="https://fonts.gstatic.com/" crossorigin>
  <!-- Compressed Styles -->
  <link href="https://centrol.io/css/slides.min.css" rel="stylesheet" type="text/css">
  ...
  <script>
    ! function (e, t, a, n, g) {
      ...
      var m = t.getElementsByTagName(a)[0],
        r = t.createElement(a);
      r.async = !0, r.src = "https://www.googletagmanager.com/gtm.js?id=GTM-TLBWCW5", m.parentNode.insertBefore(r, m)
...
<body class="slides animated noPreload">
  ...
  <section class="slide fade-6 kenBurns">
      ...
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-8-12">
            <p class="ae-1">
              <img
                src="https://res.cloudinary.com/hiwjbfp34/image/upload/c_scale,w_300/v1623727442/Centrol%20Trader%20Bot/website/centrol_love_discord.png"></img>
            </p>
            <p class="ae-2 large margin-bottom-2"><span class="opacity-7">The Centrol Trader bot lets you query realtime
                information about thousands of stocks and crypto.

                We are working on enabing user trades using the bot as-well. Stay tuned for updates!
              </span></p>
            <a class="button rounded margin-top-1 ae-5 fromCenter" style="background-color:#5865f2;"
              href="https://share.centrol.io/e/centrol-trader-bot">Get Started</a>
          </div>
    ...
    <div class="background"
      style="background-image:url(https://res.cloudinary.com/hiwjbfp34/image/upload/v1623723846/Centrol%20Trader%20Bot/website/img-11_wiugyn.jpg)">
    </div>
  </section>
  <!-- Slide 1 (#10) -->
    ...
    <div class="content">
      <div class="container">
        <div class="wrap">
          ...
          <div class="fix-7-12">
            <h1 class="smaller margin-bottom-2 ae-1">Frequently Asked Questions</h1>

            <table style="float: left; min-width: 760px;">
              <tbody>
                <tr>
                  <td style="width: 45%;">
                    <h4 class="smaller ae-2">What does the bot do?</h4>
                    <p class="ae-2 opacity-8">The bot lets you query realtime information about thousands of stocks and
                      crypto.<br />We are working on allowing user to trade using the bot as-well. Keep an eye out for
                      this!</p>
                    <h4 class="smaller ae-2">I installed the bot, what now?</h4>
                    <p class="ae-2 opacity-8">First off, thanks! You can use the bot to query real time stock and crypto
                      prices: <br /> For stocks: <br /> <code>!s AAPL</code> <br /><br /> For crypto: <br /> <code>!c
                        BTC</code> <br /><br /> By default, the price of crypto is sent against the US Dollar. However,
                      we fully support the Pound and Euro using: <br /><code>!c BTCGBP</code> <br /><code>!c
                        BTCEUR</code></p>
                  </td>
                  <td style="width: 10%;">&nbsp;</td>
                  <td style="width: 45%;">
                    <h4 class="smaller ae-2">Where can I send feedback, suggestions, and report bugs?</h4>
                    <p class="ae-2 opacity-8">We love and welcome all forms of feedback and suggestions! <br />You can
                      leave us feedback and suggestions here &rarr; <a href="https://centrol.kampsite.co/">Centrol
                        Roadmap</a> <br />Or email us directly at &rarr; <a
                        href="mailto:support@centrol.io">&nbsp;support@centrol.io</a></p>
                    <h4 class="smaller ae-2">Is the code open-source?</h4>
                    <p class="ae-2 opacity-8">Yep! You can check it out here &rarr; <br /><a
                        href="https://github.com/centrol-io/centrol_discord_bot">https://github.com/centrol-io/centrol_discord_bot</a>
                      <br />Note that we license using <a href="https://choosealicense.com/licenses/apache-2.0/">Apache
                        2.0</a>.</p>
                  </td>
                </tr>
              </tbody>
  ...
  <nav class="panel bottom forceMobileView">
    <div class="sections desktop">
      <div class="left"><span class="opacity-8"><a href="https://centrol.io" title="Centrol.io"></a></span></div>
      <div class="center"><span class="opacity-8 semiBold">Free &nbsp;•&nbsp; Frequent updates &nbsp;|&nbsp; <a
            href="https://centrol.io/terms.html">Terms</a> &nbsp;•&nbsp; <a
            href="https://centrol.io/privacy.html">Privacy</a></span></div>
      <div class="right"><span data-dropdown-id="2" class="button actionButton dropdownTrigger"><svg>
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#share"></use>
          </svg></span></div>
    </div>
    <div class="sections compact hidden">
      <div class="left"><a href="https://centrol.io" title="Centrol.io"></a></div>
      <div class="right"><span data-dropdown-id="2" class="button actionButton dropdownTrigger"><svg>
            <use xmlns:xlink="http://www.w3.org/1999/xlink" xlink:href="#share"></use>
          </svg></span></div>
    </div>
  ...
  <div class="dropdown share bottom right" data-dropdown-id="2" data-text="Take a look at this"
    data-url="https://share.centrol.io/e/centrol-trader-bot"
    data-pinterest-image="https://res.cloudinary.com/hiwjbfp34/image/upload/c_scale,w_300/v1623727442/Centrol%20Trader%20Bot/website/centrol_love_discord.png">
    <div class="center padding-2">
      <div class="title">Share</div>
      <a href="mailto:support@centrol.io">Contact us</a>
    </div>
    <ul>
  ...
  <!-- Compressed Scripts -->
  <script src="https://centrol.io/js/slides.min.js" type="text/javascript"></script>
  <noscript>
    <iframe src="https://www.googletagmanager.com/ns.html?id=GTM-TLBWCW5" height="0" width="0"
